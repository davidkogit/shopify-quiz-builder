/**
 * POST /api/admin/quizzes/[id]/unpublish — Unpublish a quiz
 *
 * Sets the quiz status back to "draft". Validates session → store →
 * quiz ownership before operating.
 */
...
import { unpublishQuiz } from "../../../../../../../lib/quiz-service";
...
// ---------------------------------------------------------------------------
// POST — Unpublish the quiz (back to draft)
// ---------------------------------------------------------------------------
...
export async function POST(
  ...
  try {
    const quiz = await unpublishQuiz(prisma, result.quizId);
